...
use fancy_garbling::{
    BinaryBundle, BinaryGadgets, Circuit, FancyBinary, FancyEncode,
    circuits::binary::{
...
impl<'a, F: FancyBinary + FancyEncode> BinaryNeuralNet<'a, F> {
...
impl<'a, F: FancyBinary + FancyEncode> FancyNeuralNet for BinaryLayer<'a, F> {
