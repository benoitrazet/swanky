// CACHE KEY c1765363d2b3e042810f279abe81c6d80d357dcc57b93fb0d992f82b86d56546
...
impl<'a> ::flatbuffers::Follow<'a> for &'a Type {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { ::flatbuffers::follow_cast_ref::<Type>(buf, loc) }
  }
}
impl<'b> ::flatbuffers::Push for Type {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const Type as *const u8, <Self as ::flatbuffers::Push>::size()) };
...
impl<'a> ::flatbuffers::Follow<'a> for TaskId {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { <&'a TaskId>::follow(buf, loc) }
  }
}
impl<'a> ::flatbuffers::Follow<'a> for &'a TaskId {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { ::flatbuffers::follow_cast_ref::<TaskId>(buf, loc) }
  }
}
impl<'b> ::flatbuffers::Push for TaskId {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const TaskId as *const u8, <Self as ::flatbuffers::Push>::size()) };
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> ::flatbuffers::PushAlignment {
...
impl<'a> ::flatbuffers::Follow<'a> for DataChunkAddress {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { <&'a DataChunkAddress>::follow(buf, loc) }
  }
}
impl<'a> ::flatbuffers::Follow<'a> for &'a DataChunkAddress {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { ::flatbuffers::follow_cast_ref::<DataChunkAddress>(buf, loc) }
  }
}
impl<'b> ::flatbuffers::Push for DataChunkAddress {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const DataChunkAddress as *const u8, <Self as ::flatbuffers::Push>::size()) };
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> ::flatbuffers::PushAlignment {
...
impl<'a> ::flatbuffers::Follow<'a> for &'a Shape {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { ::flatbuffers::follow_cast_ref::<Shape>(buf, loc) }
  }
}
impl<'b> ::flatbuffers::Push for Shape {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const Shape as *const u8, <Self as ::flatbuffers::Push>::size()) };
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> ::flatbuffers::PushAlignment {
...
impl<'a> ::flatbuffers::Follow<'a> for TaskCommunicationRound {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { <&'a TaskCommunicationRound>::follow(buf, loc) }
  }
}
impl<'a> ::flatbuffers::Follow<'a> for &'a TaskCommunicationRound {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { ::flatbuffers::follow_cast_ref::<TaskCommunicationRound>(buf, loc) }
  }
}
impl<'b> ::flatbuffers::Push for TaskCommunicationRound {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const TaskCommunicationRound as *const u8, <Self as ::flatbuffers::Push>::size()) };
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> ::flatbuffers::PushAlignment {
...
impl<'a> ::flatbuffers::Follow<'a> for TaskInput {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { <&'a TaskInput>::follow(buf, loc) }
  }
}
impl<'a> ::flatbuffers::Follow<'a> for &'a TaskInput {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { ::flatbuffers::follow_cast_ref::<TaskInput>(buf, loc) }
  }
}
impl<'b> ::flatbuffers::Push for TaskInput {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const TaskInput as *const u8, <Self as ::flatbuffers::Push>::size()) };
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> ::flatbuffers::PushAlignment {
...
impl<'a> ::flatbuffers::Follow<'a> for TaskInputTributary {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { <&'a TaskInputTributary>::follow(buf, loc) }
  }
}
impl<'a> ::flatbuffers::Follow<'a> for &'a TaskInputTributary {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { ::flatbuffers::follow_cast_ref::<TaskInputTributary>(buf, loc) }
  }
}
impl<'b> ::flatbuffers::Push for TaskInputTributary {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const TaskInputTributary as *const u8, <Self as ::flatbuffers::Push>::size()) };
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> ::flatbuffers::PushAlignment {
...
pub struct TaskPrototypeBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TaskPrototypeBuilder<'a, 'b, A> {
  #[inline]
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> TaskPrototypeBuilder<'a, 'b, A> {
...
pub struct MultiArrayTaskInputBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> MultiArrayTaskInputBuilder<'a, 'b, A> {
  #[inline]
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> MultiArrayTaskInputBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct AllocationSizeBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> AllocationSizeBuilder<'a, 'b, A> {
  #[inline]
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> AllocationSizeBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub fn root_as_manifest(buf: &[u8]) -> Result<Manifest<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_manifest(buf: &[u8]) -> Result<Manifest<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_manifest_unchecked(buf: &[u8]) -> Manifest<'_> {
  unsafe { ::flatbuffers::root_unchecked::<Manifest>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_manifest_unchecked(buf: &[u8]) -> Manifest<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<Manifest>(buf) }
}
#[inline]
