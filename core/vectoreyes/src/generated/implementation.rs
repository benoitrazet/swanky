...
unsafe { ::std::arch::x86_64::_mm_adds_epu8(a, b) } } #[inline(always)] pub(super) fn _mm_andnot_si128( a: ::std::arch::x86_64::__m128i, b: ::std::arch::x86_64::__m128i, ) -> ::std::arch::x86_64::__m128i { // SAFETY: we've verified that the required CPU flags are available.
